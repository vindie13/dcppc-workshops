...
_The following information was last updated on Aug 13, 2018._

```{r raw, message=FALSE, include=T, echo = F}
## Load raw data
df <- read_csv("~/Downloads/tito-dcppc-august-dcppc-workshop-tickets-for-rayna-harris-gmail-com-1103084.csv")
...
df$`Which Team are you a member of?` <- ifelse(grepl("Data Stewards", df$`Which Team are you a member of?`), "Data Stewards",
                  ...
                  ifelse(grepl("Phosphorus", df$`Which Team are you a member of?`), "Phosphorus", "Hydrogen"))))))))))))))
